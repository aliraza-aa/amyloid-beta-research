...
for i in range(48):
    subprocess.run(
        f"gmx_mpi_d grompp -f system/ions.mdp -c system/gro_files/topol{i}.gro -p system/topol.top -o system/simulations/confirmation{i}/genion_input.tpr", shell=True)
