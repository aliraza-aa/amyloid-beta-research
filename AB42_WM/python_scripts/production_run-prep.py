...
for i in range(0):
    ...
    subprocess.run(
        f"gmx_mpi_d grompp -f ../system/mdp_files/run.mdp -c ../system/simulations_test4_test4/replica{i}/npt_output.gro -p ../system/simulations_test4/replica{i}/topolm.top -o ../system/simulations_test4/replica{i}/production_run_input.tpr -maxwarn 1", shell=True)
