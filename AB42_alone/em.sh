...
gerun gmx_mpi_d mdrun -s system/simulations/em_input.tpr -multidir system/simulations/confirmation{0..47} -v -maxh 22 -cpi state -noappend -cpt 60 -cpnum -ntomp $OMP_NUM_THREADS &> log