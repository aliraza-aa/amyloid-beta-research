...
for i in range(48):
    ...
    subprocess.run(
        f"gmx_mpi_d grompp -f ../system/mdp_files/nvt.mdp -c ../system/simulations/confirmation{i}/confout.part0001.gro -r ../system/simulations/confirmation{i}/confout.part0001.gro -p ../system/topol.top -o ../system/simulations/confirmation{i}/nvt_input.tpr -maxwarn 1", shell=True)
